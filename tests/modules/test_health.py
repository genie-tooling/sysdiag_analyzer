...
MOCK_SYSTEMCTL_SHOW_FLAPPING = "Id=flapping.service\nLoadState=loaded\nActiveState=active\nSubState=reloading\nResult=success\nNRestarts=5"
MOCK_SYSTEMCTL_SHOW_REFUSED_SOCKET = "Id=refused.socket\nLoadState=loaded\nActiveState=active\nSubState=listening\nRefused=yes"
MOCK_SYSTEMCTL_SHOW_BAD_TIMER = "Id=badtimer.timer\nLoadState=loaded\nActiveState=active\nSubState=waiting\nResult=resources\nLastTriggerUSec=1678886461123456"
MOCK_SYSTEMCTL_SHOW_GOOD = "Id=good.service\nLoadState=loaded\nActiveState=active\nSubState=running\nNRestarts=0\nResult=success"
MOCK_SYSTEMCTL_SHOW_NOTFOUND = "Id=notfound.service\nLoadState=not-found\nActiveState=inactive\nSubState=dead\nFragmentPath=/dev/null"
